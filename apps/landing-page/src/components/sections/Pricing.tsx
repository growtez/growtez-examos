            ...
            <div>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-400">Pay only for active test takers. Perfect for coaching classes and mock series.</p>
                </div>
              </div>

              <div className="mt-6 flex items-baseline">
                <span className="text-5xl font-extrabold tracking-tight text-white">₹10</span>
                <span className="ml-1 text-sm font-semibold text-slate-400">/ student / exam</span>
              </div>
              ...
              <div className="mt-4 flex items-center gap-1.5 rounded-lg bg-slate-900/60 p-2 text-xs text-slate-400 border border-slate-800">
                ...
                <span>Credit-based system. Credits never expire.</span>
              </div>
